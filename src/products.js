...
// import product4 from "./assets/products/44.jfif";
// import product5 from "./assets/products/5.jfif";
// import product6 from "./assets/products/66.jpg";
// import product7 from "./assets/products/7.jfif";
...
// import product11 from "./assets/products/11.webp";
// import product12 from "./assets/products/12.png";
// import product13 from "./assets/products/13.jfif";
// import product14 from "./assets/products/14.png";
// import product15 from "./assets/products/15.png";
// import product16 from "./assets/products/16.jfif";

// export const PRODUCTS = [
  // {
  //   id: 1,
  //   productName: "IPhone13(Starlight,128GB)",
  //   price: 999.0,
  ...
  // {
  //   id: 4,
  //   productName: "Black Bluetooth Headset",
  //   price: 228.0,
  ...
  // {
  //   id: 8,
  //   productName: "Electric Gas Induction",
  //   price: 40.0,
  //   productImage: product8,
  // },
  // {
  //   id: 9,
  //   productName: "Electric Geysers",
  //   price: 299.0,
  ...
  // {
  //   id: 13,
  //   productName: "LED Smart Android TV",
  //   price: 690.99,
  //   productImage: product13,
  // },
  // {
  //   id: 14,
  //   productName: "SAMSUNG 253 L Frost Free Double Door 3 Star Refrigerator",
  //   price: 680.0,
